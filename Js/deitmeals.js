...
//     const UNSPLASH_ACCESS_KEY = "lRNY8tCveV4BEwlCJMXJGOJSOPgWqP1SuzvOYETNvC8"; // 🔥 Replace with your key
...
//         try {
//             let response = await fetch(`https://api.unsplash.com/search/photos?query=vegan food&per_page=10&client_id=${UNSPLASH_ACCESS_KEY}`);
...
//         if (category === "Vegan") {
//             imageUrls = await fetchVeganImages();
//             apiUrl = `https://www.themealdb.com/api/json/v1/1/search.php?s=vegan`;
//         } else {
...
//                 let imgSrc = category === "Vegan" && imageUrls[index] ? imageUrls[index] : meal.strMealThumb;
...
//                         <img src="${imgSrc}" class="w-100 object-fit-contain" style="border-radius: 10px;" alt="${meal.strMeal}">
//                         <div class="card-body">
//                             <h5 class=" text-center">${day}</h5>
