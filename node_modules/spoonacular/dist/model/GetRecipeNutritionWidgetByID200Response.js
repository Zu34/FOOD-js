...
var GetRecipeNutritionWidgetByID200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetRecipeNutritionWidgetByID200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetRecipeNutritionWidgetByID200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['bad']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['bad']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _GetRecipeNutritionWidgetByID200ResponseBadInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['good']) {
        ...
        var _iterator3 = _createForOfIteratorHelper(data['good']),
          _step3;
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _item = _step3.value;
            _GetRecipeNutritionWidgetByID200ResponseGoodInner["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
