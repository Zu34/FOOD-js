...
var GetShoppingList200ResponseAislesInner = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetShoppingList200ResponseAislesInner, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetShoppingList200ResponseAislesInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetShoppingList200ResponseAislesInnerItemsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
