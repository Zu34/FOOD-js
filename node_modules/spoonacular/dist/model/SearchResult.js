...
var _SearchResultDataPointsInner = _interopRequireDefault(require("./SearchResultDataPointsInner"));
  ...
  return _createClass(SearchResult, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('dataPoints')) {
          obj['dataPoints'] = _ApiClient["default"].convertToType(data['dataPoints'], [_SearchResultDataPointsInner["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['dataPoints']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['dataPoints']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _SearchResultDataPointsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
